...
async function this_load_dispatch_data() {
    try {
        const guard_res = await fetch('api_router.php?action=get_guards');
        ...
        const asset_res = await fetch('api_router.php?action=get_inventory');
...
async function this_execute_dispatch(form_element) {
    ...
    try {
        const response = await fetch('api_router.php', {
            method: 'POST',
            body: fd
        });
...
async function this_fetch_active_duty_logs() {
    ...
    try {
        const response = await fetch('api_router.php?action=get_issuances');

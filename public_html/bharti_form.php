...
<head>
    ...
    <title>FAST Security | Recruitment Portal</title>
    ...
    <div id="app-layout-container">
        ...
        <main class="main-workspace-window">
            ...
            <header style="margin-bottom: 40px; display: flex; align-items: center; gap: 20px;">
                <div class="brand-logo" style="width: 60px; height: 60px; fill: var(--accent-cyan);">
            ...
            <form id="bharti-wizard-form" class="glass-panel" style="padding: 40px;">
                
                <!-- TAB 01: PROFILE REGISTRY -->
                <section id="wizard-step-1" class="dynamic-field-wrapper">
                    ...
                    <div style="margin-top: 30px; text-align: right;">
                        <button type="button" class="btn-fast btn-primary" onclick="this_navigate_wizard(2)">Go to Next Step ></button>
                    </div>
                </section>

                <!-- TAB 02: SERVICE HISTORY -->
                <section id="wizard-step-2" class="dynamic-field-wrapper" style="display: none; opacity: 0;">
                    ...
                    <div style="margin-top: 30px; display: flex; justify-content: space-between;">
                        <button type="button" class="btn-fast btn-warn" onclick="this_navigate_wizard(1)">< Go Back</button>
                        <button type="button" class="btn-fast btn-primary" onclick="this_navigate_wizard(3)">Go to Next Step ></button>
                    </div>
                </section>

                <!-- TAB 03: WITNESSES -->
                <section id="wizard-step-3" class="dynamic-field-wrapper" style="display: none; opacity: 0;">
                    ...
                    <div style="margin-top: 30px; display: flex; justify-content: space-between;">
                        <button type="button" class="btn-fast btn-warn" onclick="this_navigate_wizard(2)">< Go Back</button>
                        <button type="button" class="btn-fast btn-primary" onclick="this_navigate_wizard(4)">Go to Next Step ></button>
                    </div>
                </section>

                <!-- TAB 04: SALARY & KIT -->
                <section id="wizard-step-4" class="dynamic-field-wrapper" style="display: none; opacity: 0;">
                    ...
                    <div style="margin-top: 50px; display: flex; justify-content: space-between;">
                        <button type="button" class="btn-fast btn-warn" onclick="this_navigate_wizard(3)">< Go Back</button>
                        <button type="submit" class="btn-fast btn-primary" style="background: var(--accent-cyan); color: #020406;">FINISH AND SAVE RECRUIT</button>
                    </div>
                </section>
